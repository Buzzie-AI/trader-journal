...
**Mon AM autopilot key takeaways:**
1. **MRK predicted exit ✅** — Fri close debrief flagged "MRK $117 1.4% cushion likely fires Mon" — fired at 09:31:40 ET, 1 minute after market open, +$81.54 realized
2. **OKTA breakout extending** — +8.8% intraday on top of Fri +30% = +50% lifecycle gain; stop ratcheted twice $115→$125 locks $178 floor (vs current $55 at $115)
3. **MDB Citi $455 paying through** — +9.4% intraday recovers Fri sold-the-news drift; bull stack avg $418 vs $317 entry = 32% remaining upside
4. **2 new aggressive-AI BUYs** — ORCL ($30B gov AI deal) + ARM (Mizuho PT $425 + operator-flagged); 0.74% + 1.24% book respectively; cash reserve healthy
5. **NVDA + TSM sleeve adds deferred to midday** — Alpaca wash-trade protection blocked the buys due to existing stop orders; cancel-stop-buy-re-stop workflow at midday
6. **AI exposure 13.4%→15.3% of book** post-buys; semi_ai sleeve 8.5%→9.9% (target 30%, room for $6K more)
7. **MU broke $1000** — first time in lifecycle; +13.3% from $908 entry; Wall Street "cheap at $1T" thesis paying through Computex
